export const caremeData = {
  fullProgram: [
    {
      title: 'Semaine 1 de Carême',
      range: '18–22 février',
      days: [
        {
          ...
          actions: {
            ...
            dieu: "Participer à la messe et recevoir les cendres, faire un acte de contrition",
          },
        },
        {
          date: 'Jeudi 19 février',
          title: '',
          readings: 'Dt 30,15-20 / Ps 1 / Lc 9,22-25',
          actions: {
            soi: "Écrire mes 3 résolutions définitives dans un carnet",
            prochain: "Appeler un proche que j'ai négligé depuis longtemps",
            dieu: "Méditer 15 minutes sur le choix entre la vie et la mort",
          },
        },
        {
        ...
        },
        {
          ...
          title: '',
          readings: 'Is 58,9b-14 / Ps 85 / Lc 5,27-32',
          actions: {
            soi: "Lire l'Évangile du jour et noter un enseignement",
            prochain: "Inviter quelqu'un d'éloigné de Dieu à prier avec moi",
            dieu: "Prier pour ma conversion et celle des pécheurs",
          },
        },
        {
          date: 'Dimanche 22 février',
          title: 'Dimanche — PAS DE JEÛNE',
          readings: '',
          actions: { soi: 'Repos liturgique / Messe dominicale', prochain: '—', dieu: '—' },
        },
      ],
    },
    {
      title: 'Semaine 2 de Carême',
      range: '23–28 février',
      days: [
        {
          date: 'Lundi 23 février',
          readings: 'Lv 19,1-2.11-18 / Ps 18 / Mt 25,31-46',
          actions: { soi: "Jeûner de toute plainte aujourd'hui", prochain: "Donner de l'argent à un mendiant", dieu: "Méditer sur le jugement dernier et mes œuvres de charité" },
        },
        {
          date: 'Mardi 24 février',
          readings: 'Is 55,10-11 / Ps 33 / Mt 6,7-15',
          actions: { soi: 'Me lever 30 minutes plus tôt pour prier', prochain: 'Pardonner intérieurement à quelqu\'un qui m\'a offensé', dieu: 'Copier le Notre Père et méditer chaque phrase' },
        },
        {
          date: 'Mercredi 25 février',
          readings: 'Jon 3,1-10 / Ps 50 / Lc 11,29-32',
          actions: { soi: 'Identifier mon péché principal et décider un plan pour le combattre', prochain: 'Écrire une lettre d\'encouragement à quelqu\'un', dieu: 'Lire le livre de Jonas en entier' },
        },
        {
          date: 'Jeudi 26 février',
          readings: 'Est 14,1.3-5.12-14 / Ps 137 / Mt 7,7-12',
          actions: { soi: 'Faire une liste de 5 grâces à demander au Seigneur', prochain: 'Rendre service à quelqu\'un sans qu\'il me le demande', dieu: 'Prier avec insistance pour mes intentions' },
        },
        {
          date: 'Vendredi 27 février',
          readings: 'Ez 18,21-28 / Ps 129 / Mt 5,20-26',
          actions: { soi: "Éteindre mon téléphone de 22h à 4h", prochain: 'Aller me réconcilier en personne avec quelqu\'un', dieu: 'Chemin de Croix complet' },
        },
        {
          date: 'Samedi 28 février',
          readings: 'Dt 26,16-19 / Ps 118 / Mt 5,43-48',
          actions: { soi: 'Écrire le nom de mes "ennemis" sur un papier et garder ce papier', prochain: 'Faire un acte de bonté envers une personne qui m\'a fait du mal', dieu: 'Prier pour la conversion de mes ennemis' },
        },
        { date: 'Dimanche 1er mars', title: 'Dimanche — PAS DE JEÛNE', readings: '', actions: { soi: 'Repos liturgique / Messe dominicale', prochain: '—', dieu: '—' } },
      ],
    },
    {
      title: 'Semaine 3 de Carême',
      range: '2–7 mars',
      days: [
